from OT_module.yolact_edge_project.yolact_edge.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone, MobileNetV2Backbone
...
dataset_base = Config({
    ...
    'train_images': './data/coco/all_img/',
    'train_info':   './data/coco/annotation/train.json',

    # Calibration image folder for TensorRT INT8 conversion.
    'calib_images': 'yolact_edge_project/calib/:prev:next',
    
    # Validation images and annotations.
    'valid_images': './data/coco/all_img/',
    'valid_info':   './data/coco/annotation/val.json',
