...
from OT_module.yolact_edge_project.yolact_edge.data import cfg, mask_type

import numpy as np

import pyximport
pyximport.install(setup_args={"include_dirs":np.get_include()}, reload_support=True)
from OT_module.yolact_edge_project.yolact_edge.utils.cython_nms import nms as cnms
