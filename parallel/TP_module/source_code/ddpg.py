...
import numpy as np
import sys, os
from ASeq2Seq import ASeq2Seq
import torch
import torch.nn as nn
from torch.optim import Adam

from model import (Actor, Critic, Actor_LSTM)
...
def load_ASeq2Seq():
    from ASeq2Seq import Encoder, Attention, Decoder, ASeq2Seq
...
class DDPG(object):
    def __init__(self, nb_states, nb_actions, args):
        ...
        if args.actor == 'LSTM':
            ...
            self.actor, self.actor_target = load_ASeq2Seq()
        else:
