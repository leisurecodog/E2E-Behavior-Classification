...
from OT_module.yolact_edge_project.yolact_edge.data import cfg, mask_type, MEANS, STD, activation_func
from OT_module.yolact_edge_project.yolact_edge.utils.augmentations import Resize
